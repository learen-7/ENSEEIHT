...
for ii = 1:length(Eb_N0_dB)
   ...
   %Message generation
   bits= randi([0 1],N,1);
   s = qammod(bits,M,'InputType','bit', PlotConstellation=false);
   sigs2=var(s);
   ...
   bhat_zfeq = qamdemod(xhat_zf(:),M, 'gray', OutputType='bit');
   %%%%%%
   ...
   bhat_mmseeq = qamdemod(xhat_mmse(:), M, 'gray', OutputType='bit');
