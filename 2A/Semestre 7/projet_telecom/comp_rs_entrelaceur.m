...
%entrelaceur
RS_octet = bitToOctet(RS_bits);
RS_octet_retard = [RS_octet zeros(1, 2244)];
entrelace_octet = convintrlv(RS_octet_retard, 12, 17);
entrelace = octetToBit(entrelace_octet);
...
grid on;
legend('Reed-Solomon', 'DVB-S','Theorique');
ylabel('TEB');
xlabel('E_b/N_0  (dB)');
