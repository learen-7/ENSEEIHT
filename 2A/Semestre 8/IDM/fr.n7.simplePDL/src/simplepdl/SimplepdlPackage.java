...
public interface SimplepdlPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int WORK_DEFINITION__RESSOURCE = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link simplepdl.WorkDefinition#getRessource <em>Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
